// Package password provides utility functionality for hashing and comparing passwords
package password
...
// Error definitions
var (
	ErrIncorrectHash    error = errors.New("incorrectly formatted hash provided")
	ErrIncorrectSaltLen error = errors.New("salt length should be a positive integer")
)
