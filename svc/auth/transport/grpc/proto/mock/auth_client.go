...
func (_m *AuthClient) Authorize(ctx context.Context, in *proto.AuthorizeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *proto.AuthorizeRequest, ...grpc.CallOption) (*emptypb.Empty, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *AuthClient) RegisterAccessModel(ctx context.Context, in *proto.AccessModelRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	var r0 *emptypb.Empty
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *proto.AccessModelRequest, ...grpc.CallOption) (*emptypb.Empty, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *AuthClient) Reject(ctx context.Context, in *proto.SessionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	var r0 *emptypb.Empty
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *proto.SessionRequest, ...grpc.CallOption) (*emptypb.Empty, error)); ok {
		return rf(ctx, in, opts...)
	}
...
// TokenClientFlow provides a mock function with given fields: ctx, in, opts
func (_m *AuthClient) TokenClientFlow(ctx context.Context, in *proto.TokenClientFlowRequest, opts ...grpc.CallOption) (*proto.TokenResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *proto.TokenResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *proto.TokenClientFlowRequest, ...grpc.CallOption) (*proto.TokenResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *proto.TokenClientFlowRequest, ...grpc.CallOption) *proto.TokenResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*proto.TokenResponse)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *proto.TokenClientFlowRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
