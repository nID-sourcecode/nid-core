...
func (m *SessionDB) Get(ctx context.Context, id uuid.UUID) (*Session, error) {
	var native Session
...
func (m *SessionDB) List(ctx context.Context) ([]*Session, error) {
	var objs []*Session
...
func (m *SessionDB) Add(ctx context.Context, model *Session) error {
...
func (m *SessionDB) Delete(ctx context.Context, id uuid.UUID) error {
