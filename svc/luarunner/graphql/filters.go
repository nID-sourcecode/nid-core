...
func (filter *ScriptFilterInput) parse() (string, []interface{}) {
	...
	if filter.EventType != nil {
		expr, args := filter.EventType.parse("\"scripts\".\"event_type\"")
		filterExpr = append(filterExpr, expr)
		filterArgs = append(filterArgs, args...)
	}
	if filter.OrganisationID != nil {
		expr, args := filter.OrganisationID.parse("\"scripts\".\"organisation_id\"")
		filterExpr = append(filterExpr, expr)
		filterArgs = append(filterArgs, args...)
	}
	if filter.Script != nil {
		expr, args := filter.Script.parse("\"scripts\".\"script\"")
		filterExpr = append(filterExpr, expr)
		filterArgs = append(filterArgs, args...)
	}
	if filter.CreatedAt != nil {
